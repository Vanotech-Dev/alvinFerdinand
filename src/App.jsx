    ...
    <>
      <nav className="bg-white/80 backdrop-blur-xl fixed top-0 w-full z-50 shadow-lg shadow-black/5">
        <div className="flex justify-between items-center px-8 py-6 max-w-full mx-auto">
          <div className="text-2xl font-black tracking-tighter text-neutral-900 font-epilogue">AlvinFerdinand</div>

          <div className="hidden md:flex gap-10">
            <a className="font-['Epilogue'] tracking-tight text-sm uppercase font-semibold text-orange-600 relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-full after:h-0.5 after:bg-orange-600 transition-all duration-300" href="#home">Home</a>
            <a className="font-['Epilogue'] tracking-tight text-sm uppercase font-semibold text-neutral-500 hover:text-neutral-900 transition-colors duration-300" href="#works">Works</a>
            <a className="font-['Epilogue'] tracking-tight text-sm uppercase font-semibold text-neutral-500 hover:text-neutral-900 transition-colors duration-300" href="#skills">Skills</a>
            <a className="font-['Epilogue'] tracking-tight text-sm uppercase font-semibold text-neutral-500 hover:text-neutral-900 transition-colors duration-300" href="#testimonials">Testimonials</a>
      ...
      <main>
        {/* Hero Section */}
        <section className="min-h-screen flex items-center pt-24 px-8 lg:pl-48 bg-white overflow-hidden" id="home">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-[auto_1fr] gap-12 items-center w-full">
            ...
            <div className="reveal order-1 lg:order-2">
              ...
              <div className="flex flex-wrap gap-4">
                <a className="group inline-flex items-center gap-4 bg-primary-container text-white px-10 py-5 rounded-full font-bold uppercase tracking-widest text-sm hover:scale-105 active:scale-95 transition-all cinematic-glow" href="#works">
                  View My Works
                  <span className="material-symbols-outlined group-hover:translate-x-1 transition-transform">arrow_forward</span>
                </a>
                <a className="group inline-flex items-center gap-4 bg-white text-neutral-900 px-10 py-5 rounded-full font-bold uppercase tracking-widest text-sm border border-neutral-200 hover:border-primary-container hover:text-primary-container transition-all" href="#contact">
                  Contact Me
                </a>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16 stagger">
              ...
              <div className="group cursor-pointer">
                ...
                <h3 className="text-2xl font-headline font-bold uppercase mb-1 text-neutral-900">Lorem, ipsum.</h3>
                <p className="text-neutral-400 font-label text-xs uppercase tracking-widest">Lorem ipsum dolor sit amet consectetur.</p>
              </div>
              ...
              <div className="group cursor-pointer md:translate-y-12">
                ...
                <h3 className="text-2xl font-headline font-bold uppercase mb-1 text-neutral-900">Lorem, ipsum dolor.</h3>
                <p className="text-neutral-400 font-label text-xs uppercase tracking-widest">Lorem ipsum dolor sit amet.</p>
              </div>
              ...
              <div className="group cursor-pointer">
                ...
                <h3 className="text-2xl font-headline font-bold uppercase mb-1 text-neutral-900">Lorem ipsum dolor sit.</h3>
                <p className="text-neutral-400 font-label text-xs uppercase tracking-widest">Lorem ipsum dolor sit amet.</p>
              </div>
            </div>
          </div>
        ...
        <section className="py-32 px-8 bg-[#F5F5F3]" id="skills">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-24 reveal">
              <h2 className="font-headline text-5xl md:text-7xl font-bold uppercase tracking-tighter mb-6 text-neutral-900">What I Do Best</h2>
              <p className="text-neutral-500 max-w-2xl mx-auto text-lg">Specializing in high-end motion design, from 2D vector animations to complex 3D visual effects.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-32 stagger">
              ...
              <div className="bg-white p-10 rounded-lg border border-black/5 hover:shadow-lg hover:shadow-black/5 transition-all">
                <div className="w-14 h-14 bg-orange-50 rounded-full flex items-center justify-center mb-8">
                  <span className="material-symbols-outlined text-primary-container text-3xl">animation</span>
                </div>
                <h4 className="text-xl font-headline font-bold uppercase mb-4 tracking-tight text-neutral-900">2D Animation</h4>
                <p className="text-neutral-500 text-sm leading-relaxed">Fluid vector animations and kinetic typography designed to tell compelling stories with precision.</p>
              </div>

              {/* Expertise Card 2 */}
              <div className="bg-white p-10 rounded-lg border border-black/5 hover:shadow-lg hover:shadow-black/5 transition-all">
                <div className="w-14 h-14 bg-orange-50 rounded-full flex items-center justify-center mb-8">
                  <span className="material-symbols-outlined text-primary-container text-3xl">3d_rotation</span>
                </div>
                <h4 className="text-xl font-headline font-bold uppercase mb-4 tracking-tight text-neutral-900">3D Rendering</h4>
                <p className="text-neutral-500 text-sm leading-relaxed">High-fidelity 3D modeling and photorealistic rendering using Octane and Redshift engines.</p>
              </div>

              {/* Expertise Card 3 */}
              <div className="bg-white p-10 rounded-lg border border-black/5 hover:shadow-lg hover:shadow-black/5 transition-all">
                <div className="w-14 h-14 bg-orange-50 rounded-full flex items-center justify-center mb-8">
                  <span className="material-symbols-outlined text-primary-container text-3xl">brand_awareness</span>
                </div>
                <h4 className="text-xl font-headline font-bold uppercase mb-4 tracking-tight text-neutral-900">Motion Branding</h4>
                <p className="text-neutral-500 text-sm leading-relaxed">Translating brand identities into dynamic motion languages that resonate across all digital platforms.</p>
              </div>

              {/* Expertise Card 4 */}
              <div className="bg-white p-10 rounded-lg border border-black/5 hover:shadow-lg hover:shadow-black/5 transition-all">
                <div className="w-14 h-14 bg-orange-50 rounded-full flex items-center justify-center mb-8">
                  <span className="material-symbols-outlined text-primary-container text-3xl">dashboard_customize</span>
                </div>
                <h4 className="text-xl font-headline font-bold uppercase mb-4 tracking-tight text-neutral-900">UI Animation</h4>
                <p className="text-neutral-500 text-sm leading-relaxed">Enhancing user experiences with purposeful micro-interactions and high-end interface transitions.</p>
              </div>
            </div>

            <div className="marquee-container py-12 border-y border-black/10">
              <div className="marquee-content gap-12 items-center">
                <span className="text-4xl md:text-6xl font-headline font-black text-black/10 whitespace-nowrap">AFTER EFFECTS</span>
                <span className="w-4 h-4 bg-primary-container rounded-full"></span>
                <span className="text-4xl md:text-6xl font-headline font-black text-black/10 whitespace-nowrap">CINEMA 4D</span>
                <span className="w-4 h-4 bg-primary-container rounded-full"></span>
                <span className="text-4xl md:text-6xl font-headline font-black text-black/10 whitespace-nowrap">BLENDER</span>
                <span className="w-4 h-4 bg-primary-container rounded-full"></span>
                <span className="text-4xl md:text-6xl font-headline font-black text-black/10 whitespace-nowrap">ILLUSTRATOR</span>
                <span className="w-4 h-4 bg-primary-container rounded-full"></span>
                <span className="text-4xl md:text-6xl font-headline font-black text-black/10 whitespace-nowrap">FIGMA</span>
                <span className="w-4 h-4 bg-primary-container rounded-full"></span>
            ...
            <div className="grid lg:grid-cols-2 gap-24 items-start">
              ...
              <div className="fade-up">
                <form id="contact-form" className="space-y-12">
                  ...
                  <div className="relative">
                    <input className="w-full bg-transparent border-0 border-b border-neutral-700 py-4 px-0 text-white focus:ring-0 focus:border-primary-container placeholder:text-neutral-600 transition-all font-label text-sm tracking-widest" id="email" placeholder="EMAIL ADDRESS" type="email" />
                  </div>
                  <div className="relative">
                    <select className="w-full bg-transparent border-0 border-b border-neutral-700 py-4 px-0 text-neutral-600 focus:ring-0 focus:border-primary-container transition-all font-label text-sm tracking-widest" id="service" defaultValue="">
                  ...
                  <div className="relative">
                    <textarea className="w-full bg-transparent border-0 border-b border-neutral-700 py-4 px-0 text-white focus:ring-0 focus:border-primary-container placeholder:text-neutral-600 transition-all font-label text-sm tracking-widest" id="message" placeholder="TELL ME ABOUT YOUR PROJECT" rows="4"></textarea>
                  </div>
                  <button className="w-full bg-primary-container text-white py-6 rounded-full font-bold uppercase tracking-widest hover:bg-orange-600 transition-all active:scale-95" type="submit">Send Message</button>
                </form>
              </div>
            </div>
          </div>
